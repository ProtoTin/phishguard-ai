...
The low URL threshold indicates that raw model probabilities should not yet be
interpreted as calibrated risk probabilities. Calibration and policy thresholds
will be handled separately in a later phase.
